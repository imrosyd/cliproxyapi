...
check_item "Start script" "$BIN_DIR/cpa-start" "file" "true"
check_item "OAuth script" "$BIN_DIR/cpa-oauth" "file" "true"
check_item "Update script" "$BIN_DIR/cpa-update" "file" "true"
check_item "Uninstall script" "$BIN_DIR/cpa-uninstall" "file" "true"
check_item "GUI script" "$BIN_DIR/cpa-gui" "file" "true"
check_item "Benchmark script" "$BIN_DIR/cpa-benchmark" "file" "true"
check_item "Install script" "$BIN_DIR/cpa-install" "file" "true"
